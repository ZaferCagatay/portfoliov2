export const experience = [
  {
    date: { en: '2022–Present', tr: '2022–Günümüz' },
    title: {
  ...
  {
    date: { en: '2021–2022', tr: '2021–2022' },
    title: {
      en: 'Full-Stack Development Intern',
      tr: 'Full-Stack Geliştirme Stajyeri',
    },
    company: 'Mivento Bilişim A.Ş.',
    body: {
      en: 'Frontend improvements, API integrations, debugging, performance work, and end-to-end testing with senior developers.',
      tr: 'Kıdemli geliştiricilerle arayüz iyileştirmeleri, API entegrasyonları, hata ayıklama, performans çalışmaları ve uçtan uca testler.',
    },
  },
];

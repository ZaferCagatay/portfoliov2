...
export function HeroMotion({
  ...
  return (
    <HeroMotionContext value={{ paused: stopped, target: ref }}>
      <motion.section
        ref={ref}
        className="hero-shell"
        aria-label={
          labels.reduced === 'Reduced motion on' ? 'Introduction' : 'Tanıtım'
        }
        data-motion-paused={stopped}
        data-sticky-enabled={desktop && !reduced}
        style={
          {
            ...
            '--field-opacity': fieldOpacity,
            '--pointer-x': pointerXPx,
            '--pointer-y': pointerYPx,
          } as CSSProperties
        }
      >
        <div className="hero-sticky">
          {children}
          <div className="motion-control-container container">
            <button

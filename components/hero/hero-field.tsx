...
const pingArea: [number, number, number, number] = [.12, .15, .88, .75];
export function HeroField() {
  ...
  return <div className="hero-field" aria-hidden="true">
    <SonarGrid className="sonar-canvas" paused={paused} interactionTarget={target}
      ...
      color={sonarTheme.peak} dotRadius={1.2} baseOpacity={.2}
      pingEvery={5} ringWidth={100} speed={230} amplitude={1.8}
      maxRings={4} pingArea={pingArea}>
